...
An online machine learning project investigating concept drift in political language.
...
- GDELT-based web scraper for collecting and preprocessing news articleswith diffrent balancing strategies.
...
- Extention of the `river.base.Transformer` class to combine online learning with pre-trained transformer-based embeddings (e.g., `politicalBiasBERT`, `all-MiniLM-L6-v2`).
...
## Note
This project was developed as part of the Machine Learning Methods for Data Streams course at the Warsaw University of Technology. 